...
import com.lftechnology.quest.qa.model.impl.QuestionImpl;
import com.lftechnology.quest.qa.model.impl.QuestionModelImpl;
...
public class QuestionPersistenceImpl extends BasePersistenceImpl<Question>
	 ...
	 */
	public Question create(long id) {
	...
	public Question remove(long id)
		throws NoSuchuestionException, SystemException {
	...
	public Question remove(Serializable primaryKey)
		...
		try {
			...
			if (question == null) {
				...
				throw new NoSuchuestionException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}

			return remove(question);
		}
		catch (NoSuchuestionException nsee) {
			throw nsee;
		}
		catch (Exception e) {
	...
	protected Question toUnwrappedModel(Question question) {
		...
		questionImpl.setId(question.getId());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Question findByPrimaryKey(long id)
		throws NoSuchuestionException, SystemException {
		Question question = fetchByPrimaryKey(id);
		...
		if (question == null) {
			...
			try {
				...
				if (question != null) {
					...
					EntityCacheUtil.putResult(QuestionModelImpl.ENTITY_CACHE_ENABLED,
						QuestionImpl.class, id, _nullQuestion);
				}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.lftechnology.quest.qa.model.Question")));

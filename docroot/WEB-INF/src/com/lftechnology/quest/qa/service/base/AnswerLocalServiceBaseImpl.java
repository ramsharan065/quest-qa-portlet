...
import com.lftechnology.quest.qa.service.AnswerLocalService;
import com.lftechnology.quest.qa.service.QuestionLocalService;
import com.lftechnology.quest.qa.service.persistence.AnswerPersistence;
import com.lftechnology.quest.qa.service.persistence.QuestionPersistence;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lftechnology.quest.qa.service.impl.AnswerLocalServiceImpl}.
 * </p>
 *
 * @author ramsharan
...
public abstract class AnswerLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.lftechnology.quest.qa.service.AnswerLocalServiceUtil} to access the answer local service.
	 */
	...
	public Answer createAnswer(long id) {
		return answerPersistence.create(id);
	}
	...
	public Answer deleteAnswer(long id) throws PortalException, SystemException {
		return answerPersistence.remove(id);
	}
	...
	public Answer fetchAnswer(long id) throws SystemException {
		return answerPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Answer getAnswer(long id) throws PortalException, SystemException {
		return answerPersistence.findByPrimaryKey(id);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.lftechnology.quest.qa.model.Answer",
			answerLocalService);
	}

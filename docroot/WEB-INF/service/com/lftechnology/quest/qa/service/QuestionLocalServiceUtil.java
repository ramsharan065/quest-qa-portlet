...
/**
 * The utility for the question local service. This utility wraps {@link com.lftechnology.quest.qa.service.impl.QuestionLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.lftechnology.quest.qa.service.impl.QuestionLocalServiceImpl
 * @generated
 */
public class QuestionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.lftechnology.quest.qa.service.impl.QuestionLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.lftechnology.quest.qa.model.Question addQuestion(
		com.lftechnology.quest.qa.model.Question question)
	...
	*/
	public static com.lftechnology.quest.qa.model.Question createQuestion(
		long id) {
		return getService().createQuestion(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lftechnology.quest.qa.model.Question deleteQuestion(
		long id)
	...
	*/
	...
	public static com.lftechnology.quest.qa.model.Question fetchQuestion(
		long id) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchQuestion(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lftechnology.quest.qa.model.Question getQuestion(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.lftechnology.quest.qa.model.Question> getQuestions(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lftechnology.quest.qa.model.Question updateQuestion(
		com.lftechnology.quest.qa.model.Question question)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static com.lftechnology.quest.qa.model.Question add(
		com.lftechnology.quest.qa.model.Question question) {
		return getService().add(question);
	}

	public static com.lftechnology.quest.qa.model.Question get(long id) {
		return getService().get(id);
	}

	public static com.lftechnology.quest.qa.model.Question update(
		com.lftechnology.quest.qa.model.Question question) {
		return getService().update(question);
	}

	public static com.lftechnology.quest.qa.model.Question delete(long id) {
		return getService().delete(id);
	}

	public static java.util.List<com.lftechnology.quest.qa.model.Question> getAll() {

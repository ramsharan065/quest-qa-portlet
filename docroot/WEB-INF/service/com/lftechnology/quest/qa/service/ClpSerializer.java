...
import com.lftechnology.quest.qa.model.AnswerClp;
import com.lftechnology.quest.qa.model.QuestionClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"Quest-QA-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "Quest-QA-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.lftechnology.quest.qa.model.impl.AnswerImpl")) {
			return translateOutputAnswer(oldModel);
		}

		if (oldModelClassName.equals(
					"com.lftechnology.quest.qa.model.impl.QuestionImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.lftechnology.quest.qa.NoSuchAnswerException")) {
			return new com.lftechnology.quest.qa.NoSuchAnswerException();
		}

		if (className.equals("com.lftechnology.quest.qa.NoSuchuestionException")) {
			return new com.lftechnology.quest.qa.NoSuchuestionException();
		}

...
/**
 * The utility for the answer local service. This utility wraps {@link com.lftechnology.quest.qa.service.impl.AnswerLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.lftechnology.quest.qa.service.impl.AnswerLocalServiceImpl
 * @generated
 */
public class AnswerLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.lftechnology.quest.qa.service.impl.AnswerLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.lftechnology.quest.qa.model.Answer addAnswer(
	...
	*/
	public static com.lftechnology.quest.qa.model.Answer createAnswer(long id) {
		return getService().createAnswer(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lftechnology.quest.qa.model.Answer deleteAnswer(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteAnswer(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lftechnology.quest.qa.model.Answer deleteAnswer(
		com.lftechnology.quest.qa.model.Answer answer)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static com.lftechnology.quest.qa.model.Answer fetchAnswer(long id)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchAnswer(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lftechnology.quest.qa.model.Answer getAnswer(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getAnswer(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.lftechnology.quest.qa.model.Answer> getAnswers(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lftechnology.quest.qa.model.Answer updateAnswer(
		com.lftechnology.quest.qa.model.Answer answer)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static com.lftechnology.quest.qa.model.Answer add(
		com.lftechnology.quest.qa.model.Answer answer) {
		return getService().add(answer);
	}

	public static com.lftechnology.quest.qa.model.Answer get(long id) {
		return getService().get(id);
	}

	public static com.lftechnology.quest.qa.model.Answer update(
		com.lftechnology.quest.qa.model.Answer answer) {
		return getService().update(answer);
	}

	public static com.lftechnology.quest.qa.model.Answer delete(long id) {
